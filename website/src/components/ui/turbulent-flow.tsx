...
/**
 * Organic turbulent-flow gradient, rendered with a Three.js fragment shader and
 * driven by a GSAP timeline. Adapted to fill its positioned parent (instead of
 * the whole window) so it can sit behind hero content, and to respect
 * prefers-reduced-motion by painting a single static frame.
 *
 * Shader is unchanged from the original component.
 */
export function TurbulentFlow({ className, interactive = true }: { className?: string; interactive?: boolean }) {
